...
function download_matlab_fig(btn_item: HTMLElement, fmt: string) {
    ...
    const container = btn_item.nextElementSibling as HTMLElement;
    ...
    switch (fmt) {
        case 'svg':
            data =
                ...
                btoa(
                    `<?xml version="1.0"?><!DOCTYPE svg PUBLIC '-//W3C//DTD SVG 1.0//EN' 'http://www.w3.org/TR/2001/REC-SVG-20010904/DTD/svg10.dtd'>${container.innerHTML}`
                );
...
export const downloadFiguresPlugin: JupyterFrontEndPlugin<void> = {
